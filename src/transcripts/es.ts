...
const es: transcript = {
	...
	Skills: {
		...
		Skills: [
			...
			{ name: "Ruby", years: 1, skill: 3, type: "language" },
			{ name: "Racket", years: 1, skill: 2, type: "language" },
			{ name: "AWS", years: 1, skill: 4, type: "cloud" },
